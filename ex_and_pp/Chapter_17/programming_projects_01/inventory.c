 ...
 *		 command 'q'. Prints an error message if the user enters			   *
 *		 an illegal code.													   *
 *******************************************************************************/

int main(void)
{
	inventory = malloc(sizeof(struct part) * PART_SIZE);
	char code;
...
void insert(void)
{
	...
	if (num_parts % PART_SIZE == 0 && num_parts != 0) {
		inventory = realloc(inventory, sizeof(struct part) * PART_SIZE * (num_parts / PART_SIZE * 2));
		if (inventory == NULL) {
...
/*******************************************************************************
 * search: Prompt the user to enter a part number, then looks up the part in   *
 ...
 *		  the part number, part name, and quantity on hand. Parts are printed  *
 *		  in the order in which they were entered into the database.		   *
 *******************************************************************************/
...
/*******************************************************************************
 * comparision function for qsort to sort by number 						   *
 *******************************************************************************/
...
/*******************************************************************************
 * comparision function for qsort to sort by name	 						   *
 *******************************************************************************/

int compare_parts_by_name(const void *p, const void *q)
{
